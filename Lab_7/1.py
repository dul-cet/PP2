...
bg = pygame.image.load(r'C:\Users\Moldir\VSCodeProjects\githowto\repositories\Lab_7\main-clock.png')
BG_WIDTH = 829
BG_HEIGHT = 836
BG_X_POS = (SCREEN_WIDTH / 2 - BG_WIDTH / 2)
BG_Y_POS = (SCREEN_HEIGHT / 2 - BG_HEIGHT / 2)

big_arrow = pygame.image.load(r'C:\Users\Moldir\VSCodeProjects\githowto\repositories\Lab_7\left-hand.png')
BIG_ARROW_WIDTH = 546
#BIG_ARROW_ASPECT_RATIO = 0.13
BIG_ARROW_HEIGHT = 140
#BIG_ARROW_WIDTH / BIG_ARROW_ASPECT_RATIO
big_arrow = pygame.transform.scale(big_arrow, (BIG_ARROW_WIDTH, BIG_ARROW_HEIGHT))

small_arrow = pygame.image.load(r'C:\Users\Moldir\VSCodeProjects\githowto\repositories\Lab_7\right-hand.png')
SMALL_ARROW_WIDTH = 410
#SMALL_ARROW_ASPECT_RATIO = 0.3
SMALL_ARROW_HEIGHT = 180
#SMALL_ARROW_WIDTH / SMALL_ARROW_ASPECT_RATIO
